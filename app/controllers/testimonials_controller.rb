class TestimonialsController < ApplicationController
  ...
  def create
    ...
    if verify_recaptcha(action: 'testimonial', minimum_score: 0.5, secret_key: ENV['RECAPTCHA_SECRET_KEY']) && @testimonial.save
  ...
  def testimonial_params
    params.require(:testimonial).permit(:name, :company, :title, :blurb, :rating, :website_url, photos: [])
  end
end
