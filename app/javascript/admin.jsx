    ...
    <div className="bg-white border border-slate-200 rounded-lg p-6 hover:shadow-md transition-shadow">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-display text-xl font-medium text-slate-900 mb-2 truncate">
            {project.name}
          </h3>
          <p className="text-slate-600 mb-2 italic line-clamp-2">"{project.short_description}"</p>
        ...
        <div className="flex-shrink-0 flex flex-col space-y-2">
          <button
            ...
            className="text-sm text-slate-600 hover:text-slate-900 px-4 py-2 border border-slate-300 rounded hover:bg-slate-50 transition-colors whitespace-nowrap"
          >
            Edit
          </button>
          <button
            onClick={() => onDelete(project)}
            className="text-sm text-red-600 hover:text-red-800 px-4 py-2 border border-red-300 rounded hover:bg-red-50 transition-colors whitespace-nowrap"
          >
            Delete
          </button>
        </div>
    ...
    <div className="bg-white border border-slate-200 rounded-lg p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-shrink-0 flex flex-col space-y-2">
          ...
          <button
            onClick={() => onEdit(post)}
            className="text-sm text-blue-600 hover:text-blue-800 px-4 py-2 border border-blue-300 rounded hover:bg-blue-50 transition-colors whitespace-nowrap"
          >
            Edit
          </button>
          ...
          {post.published && (
            <a
              ...
              className="text-sm text-slate-600 hover:text-slate-800 px-4 py-2 border border-slate-300 rounded hover:bg-slate-50 transition-colors inline-block text-center whitespace-nowrap"
            >
              View
            </a>
          )}
